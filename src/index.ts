...
client.on("ready", async () => {
  ...
  const r = new Discord.RichPresence()
    ...
    .setAssetsLargeImage(
      "https://cdn.discordapp.com/attachments/692443311318892585/1187272722674364446/infinite_logo_natal-cdr.png?ex=659648e3&is=6583d3e3&hm=ff6c36a3c0fb6ca077d9d645512531ffc8a578ffa1acd8db06ba8e881160b25d&",
    )
    ...
    .addButton(
      t("join"),
      "https://discord.gg/infinite-community-1014921352500756500",
    );
